...
% Timeline etc
p.expInfoRepository = fullfile(server2Name, 'Data', 'expInfo');
% p.expInfoRepository = fullfile(server1Name, 'Data2', 'Subjects');
...
p.twoPhotonRepository = fullfile(server1Name, 'Subjects');
