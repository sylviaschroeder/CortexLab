...
% code
folderTools1 = 'C:\STORAGE\workspaces';
folderTools2 = 'C:\dev\toolboxes';
folderScript = 'C:\dev\workspace\CortexLab';

%% Add paths
addpath(genpath(fullfile(folderTools1, 'allenCCF')));
addpath(genpath(fullfile(folderTools1, 'allenCCF')));
addpath(genpath(fullfile(folderTools1, 'npy-matlab')));
addpath(genpath(fullfile(folderTools2, 'AP_histology')));
addpath(genpath(fullfile(folderTools2, 'BrewerMap')));
addpath(genpath(fullfile(folderScript)));

%% 1) Load CCF and set paths for slide and slice images
allen_atlas_path = fullfile(folderTools1, 'allenCCF data');
