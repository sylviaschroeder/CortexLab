function h = plotCumHist(ax, data, null, xLimits, colors, lines, alpha)
...
if ~isempty(null)
    ...
    fill([limNull(:,1);flip(limNull(:,2))], [yNull; flip(yNull)], ...
        ...
        'FaceAlpha', alpha)
    h(2) = plot(xNull, yNull, lines{2}, 'Color', colors(2,:), 'LineWidth', 2);
end
...
h(1) = plot(x, y, lines{1}, 'Color', colors(1,:), 'LineWidth', 2);
